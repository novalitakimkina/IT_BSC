						...
						<form class="form-horizontal" method="POST">
							<fieldset>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" id="" type="text" value="" name="password">
								</div>
							  </div>
					...
					<?php
                            if (isset($_POST['simpan'])) {
                                ...
                                $hak_akses = $_POST['hak_akses'];
                                	...
                                	// print_r("insert into tbdimensi (dimensi,bobot) values ('$dimensi',$bobot)");
                                	// exit;

                                mysqli_query($koneksi, "insert into tbpengguna (username,password,hak_akses) values ('$username','$password','$hak_akses')") or die(mysqli_error());

                                header('location:tambahpengguna.php');
                            }
                            ?>
					</div>
				</div><!--/span-->
