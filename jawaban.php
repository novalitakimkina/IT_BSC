	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li><a href="#">Konfirmasi Pengisian Kuesioner</a></li>
			</ul>

			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span>Konfirmasi</h2>
						<div class="box-icon">
					...
					<div class="alert alert-block">
							...
							<p>Terima kasih anda telah mengisi kuesioner kami..</p>
						</div>	
